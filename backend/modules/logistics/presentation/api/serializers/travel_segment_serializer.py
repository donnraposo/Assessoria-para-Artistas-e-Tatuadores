...
from modules.logistics.application.services import TravelSegmentService
from modules.logistics.infrastructure.persistence.models import TravelSegment


class TravelSegmentSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        return TravelSegmentService.create(
    ...
    def update(self, instance, validated_data):
        return TravelSegmentService.update(
            segment=instance,
            actor=self.context["request"].user,
            **validated_data,
        )
